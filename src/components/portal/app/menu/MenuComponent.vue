...
<template>
  <div class="menu-container">
    <div class="logo">
      <img
        :src="require('@/assets/img/identifyBusiness/logo_age_orange.png')"
        alt="logo_age"
      />
    </div>
    ...
    <div class="items-menu">
      <router-link
        to="/inicio"
        @click="SAVE_SYSTEM({ module: 'Página inicial' })"
      ...
      <router-link
        to="/rv/inicio"
        :class="{ routed: system.module === 'Age Remuneração Variável' }"
      ...
      <router-link
        ...
        :class="{ routed: system.module === 'Age Dashboards' }"
      ...
      <router-link
        to="/relatorios/inicio"
        :class="{ routed: system.module === 'Age Relatórios' }"
      ...
      <router-link
        to="/ferramentas/inicio"
        :class="{ routed: system.module === 'Age Ferramentas e utilitários' }"
      ...
      <router-link
        to="/comunica/inicio"
        :class="{ routed: system.module === 'Age Comunica' }"
      ...
      <router-link
        to="/ajuda/inicio"
        :class="{ routed: system.module === 'Portal - Ajuda e suporte' }"
        @click="SAVE_SYSTEM({ module: 'Portal - Ajuda e suporte' })"
      >
        <div class="item">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
            <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
