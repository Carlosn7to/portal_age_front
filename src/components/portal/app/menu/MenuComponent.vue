...
export default defineComponent({
  ...
  data() {
    return {
      showDropdown: false,
      modules: [
        // Defina os módulos aqui com as propriedades como título, ícone, rota, etc.
        // Exemplo: { title: 'Módulo 1', icon: 'icon-path', route: '/modulo-1' }
        //
      ]
    };
  },
...
<template>
  <div class="menu-container">
    ...
    <div class="items-menu">
      ...
      <router-link to="/ajuda/inicio" :class="{'routed' : system.module === 'Portal - Ajuda e suporte'}"
...
@media screen and (max-width: 670px) {
  ...
  .menu-container-mobile {
    ...
    .items-menu {
      @include flex(row, flex-start, initial, 5vh);
